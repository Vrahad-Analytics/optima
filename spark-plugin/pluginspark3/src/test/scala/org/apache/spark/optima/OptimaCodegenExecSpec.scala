 ...
 */
class OptimaCodegenExecSpec extends AnyFunSuite with Matchers with BeforeAndAfterAll with SqlMetricTestHelper {
  ...
  override def beforeAll(): Unit = {
    spark = SparkSession.builder()
      ...
      .config("spark.optima.test.codegenSleepMs", SleepMs.toString)
