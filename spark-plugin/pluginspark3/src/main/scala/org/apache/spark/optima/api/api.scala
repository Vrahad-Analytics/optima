...
import org.apache.spark.optima.listener.{IcebergCommitInfo, OptimaEnvironmentInfo, OptimaDeltaLakeScanInfo}
...
case class OptimaApplicationInfo(runId: Option[String], info: ApplicationInfo, environmentInfo: Option[OptimaEnvironmentInfo])

case class IcebergInfo(commitsInfo: Seq[IcebergCommitInfo])

case class DeltaLakeScanInfo(scans: Seq[OptimaDeltaLakeScanInfo])
