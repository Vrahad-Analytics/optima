...
spark = SparkSession \
    ...
    .config("spark.optima.instrument.spark.window.enabled", "true") \
    .config("spark.optima.instrument.spark.arrowEvalPython.enabled", "true") \
    .config("spark.optima.instrument.spark.batchEvalPython.enabled", "true") \
    .config("spark.optima.instrument.spark.flatMapGroupsInPandas.enabled", "true") \
    .config("spark.optima.instrument.spark.flatMapCoGroupsInPandas.enabled", "true") \
    .config("spark.optima.instrument.spark.sqlNodes.enabled", "true") \
    .master("local[*]") \
    .getOrCreate()
